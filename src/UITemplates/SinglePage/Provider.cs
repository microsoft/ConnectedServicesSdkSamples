...
{
    [ConnectedServiceProviderExport("Microsoft.Samples.SinglePage")]
    internal class Provider : ConnectedServiceProvider
    {
        public Provider()
        {
            this.Name = "Sample Configurator: Single Page";
            this.Category = "Contoso";
            this.Description = "A sample Connected Service demonstrating Single Page configuration";
